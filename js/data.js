...
*/
let PRODUCTS = [
  /* ── FOOD & DRINKS (The Daily Brew / Campus Bakery) ── */
  {
    id: 'p01', name: 'Cold Coffee', price: 120, emoji: '☕', bg: '#FEF9EB',
    image: 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=500&auto=format&fit=crop&q=80',
    categoryId: 'food', storeId: 'campus-cafe', subCategory: 'Coffee',
    description: 'Smooth, slow-steeped cold coffee blended with fresh milk and ice cream.',
  ...
  {
    id: 'p01b', name: 'Iced Americano', price: 110, emoji: '🧊', bg: '#FEF9EB',
    image: 'https://images.unsplash.com/photo-1551030173-122aabc4489c?w=500&auto=format&fit=crop&q=80',
    categoryId: 'food', storeId: 'campus-cafe', subCategory: 'Coffee',
    description: 'Double shot rich espresso poured over chilled water and ice.',
  ...
  {
    id: 'p17', name: 'Veg Sandwich', price: 90, emoji: '🥪', bg: '#F0FDF4',
    image: 'https://images.unsplash.com/photo-1528735602780-2552fd46c7af?w=500&auto=format&fit=crop&q=80',
    categoryId: 'food', storeId: 'campus-cafe', subCategory: 'Snacks',
    description: 'Fresh toasted artisan sandwich loaded with garden veggies and house herb spread.',
  ...
  {
    id: 'p18b', name: 'Chocolate Muffin', price: 70, emoji: '🧁', bg: '#FFF7ED',
    image: 'https://images.unsplash.com/photo-1607958996333-41aef7caefaa?w=500&auto=format&fit=crop&q=80',
    categoryId: 'food', storeId: 'campus-cafe', subCategory: 'Bakery',
    description: 'Decadent double chocolate chip muffin, baked fresh every morning in the campus bakery.',
  ...
  },
  {
    ...
    categoryId: 'food', storeId: 'campus-cafe', subCategory: 'Beverages',
  ...
  },
  {
    ...
    categoryId: 'food', storeId: 'campus-mart', subCategory: 'Snacks',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1622484212850-cab596d63c5d?w=500&auto=format&fit=crop&q=80',
    categoryId: 'food', storeId: 'health-hub', subCategory: 'Snacks',
